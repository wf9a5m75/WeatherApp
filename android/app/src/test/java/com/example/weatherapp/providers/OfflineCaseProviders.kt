...
class OfflineCaseProviders {
    companion object {

        fun provideNetworkMonitor() = mock<INetworkMonitor> {
            on { this.isOnline } doReturn true
        }

        fun provideWeatherApi() = mock<IWeatherApi> {
        ...
        fun providePrefectureDao() = mock<PrefectureDao> {
        ...
        fun provideKeyValueDao() = mock<KeyValueDao> {
        ...
        fun provideWeeklyForecastDao() = mock<WeeklyForecastDao> {
